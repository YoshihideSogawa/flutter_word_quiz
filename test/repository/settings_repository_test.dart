...
void main() {
  ...
  test('inputType(save/load)', () async {
    final container = ProviderContainer();
    final settingsRepository = container.read(settingsRepositoryProvider);
    await settingsRepository.saveInputType(inputTypeSwitching);

    final inputType = settingsRepository.inputType();
    expect(inputType, inputTypeSwitching);
  });
