...
_WordInput _$WordInputFromJson(Map<String, dynamic> json) => _WordInput(
  wordsList:
      (json['wordsList'] as List<dynamic>?)
          ?.map((e) => (e as List<dynamic>?)?.map((e) => e as String).toList())
          .toList() ??
      const <InputWords?>[],
  wordsResultList:
      (json['wordsResultList'] as List<dynamic>?)
          ?.map(
            (e) => (e as List<dynamic>?)
      ...
      const <WordResults?>[],
  keyResultList:
      (json['keyResultList'] as Map<String, dynamic>?)?.map(
...
Map<String, dynamic> _$WordInputToJson(_WordInput instance) =>
    <String, dynamic>{
      'wordsList': instance.wordsList,
      'wordsResultList': instance.wordsResultList
          .map((e) => e?.map((e) => _$WordNameStateEnumMap[e]!).toList())
          .toList(),
      'keyResultList': instance.keyResultList.map(
        (k, e) => MapEntry(k, _$WordKeyboardInfoEnumMap[e]!),
      ),
